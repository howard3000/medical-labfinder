...
<body class="g-sidenav-show bg-gray-100">
    ...
    <main class="main-content border-radius-lg">
        ...
        <div class="container-fluid py-4">
            <form action="{{ url('update_lab_profile', $lab->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div style="width:100% !important" class="form-group mb-5">
                    <label for="exampleInputEmail1">Lab Name</label>
                    <input name="name" value="{{ $lab->name }}"
                        style="border:1px solid grey; border-radius:5px; !important" type="text" class="form-control"
                        placeholder="Enter Name of the lab">
                </div>
                ...
                <div class="form-group mb-5">
                    <select id="tests" multiple name="tests[]"
                        ...
                        <option selected value="{{ $lab->tests }}">{{ $lab->tests }}</option>
                ...
                <div class="form-group mb-5">
                    <select name="location" style="width:100%; height:40px; border-radius:6px; padding:5px;"
                        class="custom-select custom-select-lg mb-3">
                        <option value="{{ $lab->location }}" selected>{{ $lab->location }}</option>
                ...
                <img style="display:block;" height="100px" src="ProfileImages/{{ $lab->profile }}" alt="profileimage">
